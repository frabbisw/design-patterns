...
public class AfricaBuilder  extends ContinentBuilder{

	@Override
	public House getHouse(int x0, int y0, int width, int height) {
		// TODO Auto-generated method stub
		return HouseBuilder.getAfricanHouse(x0, y0, width, height);
	}

	@Override
	public Tree getTree(int x0, int y0, int width, int height) {
		// TODO Auto-generated method stub
		return TreeBuilder.getAfricanTree(x0, y0, width, height);
	}
