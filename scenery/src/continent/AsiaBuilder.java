...
public class AsiaBuilder  extends ContinentBuilder{

	@Override
	public House getHouse(int x0, int y0, int width, int height) {
		// TODO Auto-generated method stub
		return HouseBuilder.getAsianHouse(x0, y0, width, height);
	}

	@Override
	public Tree getTree(int x0, int y0, int width, int height) {
		// TODO Auto-generated method stub
		return TreeBuilder.getAsianTree(x0, y0, width, height);
	}
